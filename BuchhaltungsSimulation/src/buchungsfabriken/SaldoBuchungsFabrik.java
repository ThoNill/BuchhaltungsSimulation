 ...
 * 
 */
public class SaldoBuchungsFabrik extends BuchungsFabrik implements PropertyChangeListener {
	...
	private void calculateEnabled() {
		setEnabled((sollSaldo)? saldokonto.getSaldo()>0 : saldokonto.getSaldo()<0);
	}
