...
public class KontoPanel extends JPanel implements PropertyChangeListener {
	...
	public KontoPanel(TableCellRenderer cellRenderer) {
		super();
	...
	public void init() {
		...
		tabelle.setRowHeight((int) (tabelle.getRowHeight() * FontResize.getFontScale() * 1.5));
	...
	private void changeModel() {
		...
		tabelle.getColumnModel().getColumn(0)
				.setCellRenderer(cellRenderer);
		tabelle.getColumnModel().getColumn(1)
				.setCellRenderer(cellRenderer);
